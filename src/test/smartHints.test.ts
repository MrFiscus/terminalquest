...
const state = (cwd = START_PATH): GameState => ({
  ...
  commandStats: {
    ...
    clear: { uses: 0, mistakes: 0 },
    echo: { uses: 0, mistakes: 0 },
    touch: { uses: 0, mistakes: 0 },
    cp: { uses: 0, mistakes: 0 },
    grep: { uses: 0, mistakes: 0 },
    help: { uses: 0, mistakes: 0 },
    hint: { uses: 0, mistakes: 0 },
    man: { uses: 0, mistakes: 0 },
  },
  recentMistakes: [],
  won: false,
  animating: false,
